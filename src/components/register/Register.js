          ...
          <form>
            <div className="middleContainer">
              ...
              {type === "list" ? (
                ...
                <div className="childContainer">
                  <button className="btn" onClick={handelLog}>
                    LogIn
                  </button>
                </div>
              )}
              <div>
                {type === "list" ? (
                  <div className="card text-center" style={{ width: "18rem" }}>
                    <p>
                      ...
                      <span style={{ color: "blue" }}> Term & Conditions </span>{" "}
                      and{" "}
                ...
                <div className="card text-center" style={{ width: "18rem" }}>
                  <p>
                    All rights reserved. Copyright (2006-2023) -
                    <span style={{ color: "blue" }}> BOOKING.COM</span>{" "}
                  </p>
                </div>
              </div>
            </div>
